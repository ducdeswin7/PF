...
<html lang="en" class="no-js">
	<head>
        ...
        <meta name="description" content="Boevi L lawson portfolio"/>
        <meta name="keywords" content="Boevi L lawson portfolio, portfolio, boevi lawson portfolio, avengers, avengers project, boevi, lawson, siwin, lion, boevi.lawsonplacca"/>
		<title>Boevi L portfolio</title>
	...
	<body>
		...
		<!--HEADER-->
			<header id="header" class="codrops-header">
				<h1><a href="#slide1" title="Home"><img src="img/logo-nameW.png" alt="boevi lawson logo" class="logo"></a></h1>
		...
		<!--BEGIN OVERLAY-->
			<div id="overlay" class="overlay">
				<div class="info">
					<h2>How to interact in my website</h2>
					<span class="info-drag">Drag Sliders</span>
					<span class="info-keys">Use Arrows</span>
					<span class="info-switch">Menu</span>
					<button>Got it!</button>	
				</div>
			</div>
		<!--SLIDE PART-->
			<div id="slideshow" class="dragslider" id="home">
				<section class="img-dragger img-dragger-large dragdealer">
					<div class="handle">
					<!--SLIDE1-->
						<div class="slide" id="slide1" data-content="content-1">
							<div class="img-wrap"><img src="img/bglion.jpeg" alt="lion image home "/></div>
							<div class="img-pattern"></div>
							<h2><!-- I work like a lion -->HOME
							<span >The best way of imposing an idea to the others, it is to persuade them that it comes from them. <br> <span>(Alphonse Daudet)</span></span>
							</h2>
							<button class="content-switch">feed</button>
						</div>
						<!--SLIDE2-->
						<div class="slide" id="slide2" data-content="content-2">
							<div class="img-wrap"><img src="img/portf.jpeg" alt="desktop image"/></div>
							<h2 class="portfolioTitle">Portfolio<span>everyday i try to learn something new, I like to share what i know, so let me show you my project</span></h2>
							<button class="content-switch">My work</button>
						</div>
						<!--SLIDE3-->
						<div class="slide" id="slide3" data-content="content-3">
							<div class="img-wrap"><img src="img/vague.jpeg" alt="coffee image"/></div>
							<h2>About<span></span></h2>
							<button class="content-switch">Smile life is short</button>
						</div>
						<!--SLIDE4-->
						<div class="slide" id="slide4" data-content="content-4">
							<div class="img-wrap"><img src="img/picjumbo.jpg" alt="contact image"/></div>
							<h2>Get in touch <span>after all , let's work together</span></h2>
							<button class="content-switch">Contact</button>
						</div>
					</div>
				</section><!-- /img-dragger-->
				<!-- Content section -->
				<section class="pages">
				<!--- Content1 for part Home -->
					<div class="content" id="content1" data-content="content-1">
					<!-- TIMELINE-->
                         <div class="main">
                            <h1>MY TIMELINE</h1>
                            <ul class="cbp_tmtimeline">
                                <li>
                                    <time class="cbp_tmtime" datetime="2015-05-13 16:15"><span>13/05/15</span> <span>16:15</span></time>
                                    <div class="cbp_tmicon cbp_tmicon-phone"></div>
                                    <div class="cbp_tmlabel">
                                        <h2>Update on contact page</h2>
                                        <p>i gave to my contact section a new style...</p>
                                    </div>
                                </li> <li>
                                    <time class="cbp_tmtime" datetime="2015-05-02 18:15"><span>02/05/15</span> <span>18:47</span></time>
                                    <div class="cbp_tmicon cbp_tmicon-phone"></div>
                                    <div class="cbp_tmlabel">
                                        <h2>Symfony 2 :)</h2>
                                        <p>symfony 2 is just amazing and fast , i like it , i just begin it. </p>
                                    </div>
                                </li>
                                <li>
                                    <time class="cbp_tmtime" datetime="2015-04-14 06:30"><span>14/04/15</span> <span>06:30</span></time>
                                    <div class="cbp_tmicon cbp_tmicon-phone"></div>
                                    <div class="cbp_tmlabel">
                                        <h2>Responsive Blog Sample</h2>
                                        <p>I added my projects on my site, that project it's about a responsive</p>
                                    </div>
                                </li>
                                <li>
                                    <time class="cbp_tmtime" datetime="2015-03-15 02:30"><span>29/03/15</span> <span>02:45</span></time>
                                    <div class="cbp_tmicon cbp_tmicon-phone"></div>
                                    <div class="cbp_tmlabel">
                                        <h2>project update</h2>
                                        <p>I added my projects on my site</p>
                                    </div>
                                </li>
                                <li>
                                    <time class="cbp_tmtime" datetime="2015-01-26 12:04"><span>26/01/15</span> <span>12:04</span></time>
                                ...
                                <li>
                                    <time class="cbp_tmtime" datetime="2015-01-26 12:04"><span>26/01/15</span> <span>08:34</span></time>
                                    <div class="cbp_tmicon cbp_tmicon-screen"></div>
                                    <div class="cbp_tmlabel">
                                        <h2>First update commit </h2>
                                        <p>the story just begin</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    </div>
                <!--- Content2 for part Portfolio -->
                      <div class="content" id="content2" data-content="content-2">
                            <h1>MY WORK</h1>
                            <div class="portfolioImage">
                                <ul>
                                     <li>
	                                     <div class="avengers">
	                                     	<div class="linkCover">
	                                            <a href="http://avengersfilm.esy.es/" target="_blank" title="Avengers: age of ultron - 2015">Avengers School Project</a>
	                                        </div>
	                                     </div>
                                        </li>
                                   <li>
		                                   <div class="hetix">
		                                   	 	<div class="linkCover">
		                                            <a href="http://enigmhetix.16mb.com/" target="_blank" title="Projet EnignHetix">EnigmHetix Game Project</a>
		                                        </div>
		                                   </div>
                                   </li>
                                    <li>
		                                   <div class="blog">
		                                   	 	<div class="linkCover">
		                                            <a href="http://blog-responsive.pe.hu/" target="_blank" title="Responsive blog">Responsive blog Sample
                                                        <!--<span class="portText"> We made this responsive web for test the responsive, it's just a nice sample ...</span>-->
                                                    </a>
		                                        </div>
		                                   </div>
                                   </li>
                ...
                <!-- Content3 for part About Me -->
                     <div class="content" id="content3" data-content="content-3">
                            <section class="about">
                            <h1>I'm web designer & developer</h1>
                                    <div class="profil">
                                    <!-- <p><img src="img/lion.png" alt=""></p> -->
                                    	<p class="lionAbout">
											<svg>
                                    ...
                                    <div class="aboutMe">
                                       ...
                                       <p>My name is Boevi LAWSON,   living in <a href="http://www.paris.fr/" title="paris big cty in france">PARIS</a>, I’m passionate by web development ,<br/>
                        I’m currently learning web design & developpment at <a href="http://www.hetic.net/" title="Web school in Paris">HETIC</a>.<br/>
                                        I like to design and create websites, discover new things.<br/> I post snapshots of what I'm working on (sometimes). Also I'm a video game addict.<br/>
                                       you can also download <a href="img/moncv.pdf" title="my cv">my resume</a>.<br/>
                                       yes, I speak la <a href="http://www.france.fr/" title="France">France</a>, Baguette, Fromage.<br/>
                                        And before you leave, you have to know, I am looking for a 4 months internship in Paris.</p>
                                    </div>
                            </section>
                      </div>
               <!--- Content4  for part Contact -->
						  <div class="content" id="content4" data-content="content-4">
									<h1>LET'S WORK TOGETHER</h1>



                              <div id="mail">
                                  You can just send me a message by <a href="mailto:boevilawson@outlook.com">Email</a>
                              </div>
                              <div id="after">
                                  after that you can add me on
                              </div>
                              <div id="socialNetwork">
                                  <ul>
                                      <li class=""><a href="https://www.facebook.com/boevi.lawsonplacca" target="_blank" title="boevi lawson facebook"><img src="img/1431541278_facebook-128.png" alt="icon facebook"/></a></li>
                                      <li class=""><a href="https://www.linkedin.com/profile/view?id=324565824&trk=nav_responsive_tab_profile" title="boevi lawson linkedin" target="_blank"><img src="img/1431541296_linkedin-128.png" alt="icon linkedin"/></a></li>
                                      <li class=""><a href="https://twitter.com/phrenel" title="boevi lawson twitter" target="_blank"><img src="img/1431541288_twitter-128.png" alt="icon twitter"/></a></li>
                                      <li class=""><a href="https://github.com/ducdeswin7" title="boevi lawson Github" target="_blank"><img src="img/1431706659_github-256.png" alt="icon github"/></a></li>
                                  </ul>
                              </div>
